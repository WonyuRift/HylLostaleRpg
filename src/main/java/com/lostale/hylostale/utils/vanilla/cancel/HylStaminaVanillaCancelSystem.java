package com.lostale.hylostale.utils.vanilla.cancel;
...
public class HylStaminaVanillaCancelSystem extends EntityTickingSystem<EntityStore> {

    private final Map<String, Float> staminaMap;
    private final Query<EntityStore> query;
    private final Set<Dependency<EntityStore>> dependencies;

    public HylStaminaVanillaCancelSystem(Map<String, Float> staminaMap) {
